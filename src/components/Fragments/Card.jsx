    ...
    const { title, image, description, link } = props
        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 mx-3 lg:mx-12 md:mx-5">
                ...
                <img src={image} className="mt-10 lg:mt-19 md:mt-5 md:mb-5 rounded-xl cursor-pointer hover:scale-105 duration-500 transition-transform w-[350px] lg:w-[700px] md:w-[650px]" alt="picture" />
                </a>
